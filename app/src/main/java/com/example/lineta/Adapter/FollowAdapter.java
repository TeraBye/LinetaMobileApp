...
public class FollowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FollowAdapter(List<UserFollowResponse> users, Context context) {
        this.users = users;
...
//            userHolder.btnFollow.setText(user.isFollowing() ? "Following" : "Follow");
//            userHolder.btnFollow.setOnClickListener(v -> {
//                if (followClickListener != null) {
//                    followClickListener.onFollowClick(user.getId(), user.isFollowing());
//                }
//            });
